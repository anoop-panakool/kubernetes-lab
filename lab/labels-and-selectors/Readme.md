...
Let's create a POD named [labelex.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/labelex.yaml) that initially has one label (`env=development`):
```yaml
apiVersion: v1
kind: Pod
metadata:
...
Let's launch POD named [labelexother.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/labelexother.yaml)
...
Let's create a POD named [kubia-manual-with-labels.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/kubia-manual-with-labels.yaml)
...
```
Create the Pod named kubia-gpu from file [kubia-gpu.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/kubia-gpu.yaml)
...
Create the Pod named `nginx`from file [pod-nginx.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/pod-nginx.yaml)
...
Create the Pod named `nginx`from file [pod-nginx-specific-node.yaml](https://github.com/shivamjhalabfiles/kubernetes-lab/blob/master/lab/labels-and-selectors/pod-nginx-specific-node.yaml)
